...
## 6. Scene size (Open Question 1, resolved)

The question was "how many objects must the renderer handle?" Answering it
showed the word _objects_ was hiding two different quantities — **elements**
(indexed, hit-tested, undoable) and **drawn primitives** (painted each frame). A
ten-seat round table is one element and eleven shapes.

### Venue capacity anchors

| Source                               | Figure                                                              |
| ------------------------------------ | ------------------------------------------------------------------- |
| Industry planning guidance           | 1,000 guests ≈ 125 round tables                                     |
| Grand Hyatt Hong Kong Grand Ballroom | 1,248 banquet / 2,016 theatre                                       |
| Hyatt Regency Denver                 | 3,000 seated                                                        |
| Marriott Marquis, Washington DC      | 3,500 theatre-style — among the largest anywhere                    |
| Cvent / SeatPlan / Prismm            | No published object limit. One review notes "large models can lag." |

Sources: [largest hotel ballrooms](https://www.businesstraveller.com/features/hotel-ballrooms-bigger-is-better/) ·
[banquet capacity planning](https://www.webstaurantstore.com/blog/115/how-many-people-can-different-size-banquet-tables-seat-comfortably.html) ·
[CAD block practice for event layouts](https://forums.autodesk.com/t5/autocad-lt-forum/event-seating-plan/td-p/12859832)

### Resolution

Seats are generated by their parent element rather than stored individually
([ADR-0012](adr/ADR-0012-seat-generation.md)). That yields:
...
**ADR-0001 holds.** Its reversal condition — realistic scenes above ~5,000
objects — is not met, and not narrowly: element counts land around a fifth of
the threshold that would have forced WebGL.

The library benchmark that informed ADR-0001 measured _interactive scene-graph
