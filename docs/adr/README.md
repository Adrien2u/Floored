...
| [0007](ADR-0007-to-scale-pdf.md)          | To-scale vector PDF, never rasterized                 | Accepted (writer per 0011) |
...
| [0011](ADR-0011-pdf-writer.md)            | Write PDFs ourselves rather than depend on pdf-lib    | Accepted (provisional)     |
